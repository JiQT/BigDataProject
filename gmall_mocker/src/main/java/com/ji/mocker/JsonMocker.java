package com.ji.mocker;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.ji.utils.RanOpt;
import com.ji.utils.RandomDate;
import com.ji.utils.RandomNum;
import com.ji.utils.RandomOptionGroup;
import com.ji.app.LogUploader;
...
public class JsonMocker {
    ...
    private RanOpt[] areaOpts = {new RanOpt("beijing", 10),
            new RanOpt("shanghai", 10), new RanOpt("guangdong", 20),
            new RanOpt("hebei", 5),
            new RanOpt("heilongjiang", 5), new RanOpt("shandong", 5),
            new RanOpt("tianjin", 5),
            new RanOpt("shanxi", 5), new RanOpt("shan1xi", 5), new RanOpt("sichuan", 5)
    };
    ...
    private RanOpt[] vsOpts = {new RanOpt("1.2.0", 50), new RanOpt("1.1.2", 15),
            new RanOpt("1.1.3", 30), new RanOpt("1.1.1", 5)
    };
    private RandomOptionGroup<String> vsOptionGroup = new RandomOptionGroup(vsOpts);
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 10), new
            RanOpt("addComment", 30),new RanOpt("addCart", 20), new
            RanOpt("clickItem", 40), new RanOpt("coupon", 45)};
    ...
    public JsonMocker(String startTimeString, String endTimeString,
                      int startupNum, int eventNum) {
        try {
    ...
    */
    ...
    private String initStartsupLog() {
        ...
        //long ts= logDateUtil.getRandomDate().getTime();
        String ch = os.equals("ios") ? "appstore" :
                channelOptionGroup.getRandomOpt().getValue();
        JSONObject jsonObject = new JSONObject();
